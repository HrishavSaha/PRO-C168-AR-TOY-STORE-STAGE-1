AFRAME.registerComponent("create-markers", {
  init: async function () {
    ...
    dishes.map(dish => {
      ...
      marker.setAttribute("url", dish.pattern_marker_url);
      ...
      if (!dish.unavailable_days.includes(days[todaysDay])) {
        ...
        //model.setAttribute("gltf-model", `./assets/models/crane/crane.glb`);
        ...
        dishTitle.setAttribute("text", {
          ...
          height: 1,
          align: "center",
          value: dish.toy_name.toUpperCase()
        });
        ...
        rating.setAttribute('text', {
          ...
          width: 3,
          align: 'center',
          value: dish.last_rating
          })

        // Dish review plane
        var dishReviewPlane = document.createElement('a-entity')
